...
def prepare_dataloader(num_workers=8, train_batch_size=128, eval_batch_size=256):
    ...
    # train_set = torchvision.datasets.ImageNet(root="data", split='train', download=True, transform=train_transform)
    # test_set = torchvision.datasets.ImageNet( root="data", split='test', download=True, transform=test_transform)
    # exit()
...
def create_model(num_classes=10):
    ...
    # model = MobileNet(n_class=num_classes)
...
def main():
    ...
    train_loader, test_loader = prepare_dataloader(
        num_workers=8, train_batch_size=128, eval_batch_size=1)
